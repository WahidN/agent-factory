...
export type Heartbeat<T> = {
  ...
  // Call once per tick, after pinging everyone still tracked. Returns the
  // clients that missed two ticks in a row and should be terminated; those
  // clients stop being tracked.
  onTick(): T[];
};
